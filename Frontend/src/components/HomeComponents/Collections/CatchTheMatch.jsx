  ...
  useEffect(() => {
    const fetchRestaurants = async () => {
      try {
        ...
        // Fetch restaurants with alcohol/pub filter for match viewing
        const response = await axiosApi.get(
          `${
            import.meta.env.VITE_SERVER_URL
          }/firm/getnearbyrest?Alcohol=true&cursor=${baseParams.cursor}&lat=${
            baseParams.lat
          }&lon=${baseParams.lon}&radius=${baseParams.radius}&limit=20`
        );
    ...
    <div className="bg-gray-100 min-h-screen pb-10">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-end p-8">
          <div className="flex justify-between items-end">
            <div className="text-white">
              ...
              <h1 className="text-4xl font-bold mb-2">Catch the Match</h1>
              <p className="text-lg mb-2">
                The best places to enjoy live sports with great food and drinks
              </p>
      ...
      <div className="bg-white py-4 px-8 border-b">
        <div className="max-w-7xl mx-auto flex items-center text-sm">
          ...
          <span className="mx-2 text-gray-500">/</span>
          <span className="text-gray-900">Catch the Match</span>
        </div>
      </div>
