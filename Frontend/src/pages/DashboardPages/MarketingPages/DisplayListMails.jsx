      ...
      case "starred":
        axiosApi
          .get(
            ...
            }/email/star?page=${currentPage}&limit=${limit}`,
            {
              headers: {
      ...
      case "trash":
        axiosApi
          .get(
            `${
              import.meta.env.VITE_SERVER_URL
            }/email/isTrashed?page=${currentPage}&limit=${limit}`,
            {
              headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
              },
      ...
      case "drafts":
        axiosApi
          .get(
            `${
              import.meta.env.VITE_SERVER_URL
            }/email/isDraft?page=${currentPage}&limit=${limit}`,
            {
              headers: {
                Authorization: `Bearer ${localStorage.getItem("token")}`,
              },
              ...
              filteredMails.map((m, index) => (
                ...
                >
                  ...
                  <div
                    ...
                    onClick={() => handleMailClick(m, "open")}
                  >
