...
const PhoneInput = ({ value, onChange, errors, required = false }) => {
  const countryCodes = {
    // North America
  ...
  return (
    <div className="mt-0 w-full">
      {/* <label
        htmlFor="phone"
        className="block font-medium text-gray-700 text-sm mt-0"
      >
        Phone
      </label> */}
      <div className="flex gap-2 w-full">
        <select
          ...
          className="w-40 py-1 px-2 h-12 border rounded-md bg-white text-sm"
        >
        ...
        <div className="flex-1 w-full">
          <input
            ...
            className={`w-full py-1 px-2 h-12 border rounded-md ${
