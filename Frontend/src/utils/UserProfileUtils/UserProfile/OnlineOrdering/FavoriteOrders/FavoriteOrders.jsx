...
const TakeawayOrders = ({ hashId }) => {
    ...
    const fetchOrders = useCallback(async (page) => {
        ...
        try {
            const response = await Axios.get(
                `${SERVER_URL}/api/orderFav?page=${page}&limit=10&type=Firm`,
                {
    ...
    return (
        <div className="w-full mx-auto px-4 bg-gray-50 min-h-screen">
            <h1 className="text-3xl font-extrabold text-gray-900 mb-8 text-center border-b pb-4">Your Favorite Orders</h1>
                        ...
                        <>
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6">
                                {orders.map((order, index) => {
                                    ...
                                    const restaurantImage = firstItem.sourceEntityId?.image_urls ? firstItem.sourceEntityId?.image_urls[0] : "https://placehold.co/150x150/f0f9ff/00796b?text=Restaurant";
