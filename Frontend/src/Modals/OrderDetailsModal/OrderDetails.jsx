          ...
          <div className={css.orderDetailsDiv}>
            ...
            <div className={css.obdy}>
              ...
              <div className={css.obdyBox}>
                ...
                <div className={css.obytxt}>
                  {curState?.phone ? (
                    <span>{data?.phone?.slice(0, -3) + "XXX"}</span>
                  ) : (
              ...
              <div className={css.obdyBox}>
                ...
                <div className={css.obytxt}>
                  ...
                  <div
                    ...
                    onClick={() =>
                      setCurState((val) => {
                        return { ...val, deliverTo: !val.deliverTo };
                      })
                    }
                  >
                    {curState?.deliverTo ? (
            ...
            <div className={css.ofooter}>
              ...
              <div className={css.oimgBox}>
                <img src={fssaiIcon} className={css.oImgFssai} alt="fssai" />
              </div>
              <div className={css.onum}>
                Lic. No. <span className={css.onum}>{data.licNo}</span>
              </div>
            </div>
          </div>
        </div>
